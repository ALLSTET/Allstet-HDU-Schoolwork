  ...
  for (int i = 0; i < size; i++) {
    ...
    for (int j = 0; j < size; j++) {
      if (Game_Pointer[i][j] != 0) {
        int num = Game_Pointer[i][j];
        switch (num) {
          case 2: SetColor(COLOR_2); break;
          case 4: SetColor(COLOR_4); break;
          case 8: SetColor(COLOR_8); break;
          case 16: SetColor(COLOR_16); break;
          case 32: SetColor(COLOR_32); break;
          case 64: SetColor(COLOR_64); break;
          case 128: SetColor(COLOR_128); break;
          case 256: SetColor(COLOR_256); break;
          case 512: SetColor(COLOR_512); break;
          case 1024: SetColor(COLOR_1024); break;
          case 2048: SetColor(COLOR_2048); break;
          default: SetColor(COLOR_DEFAULT); break;
        }
        printf("| %3d ", num);
